...
public class ServletTipoServicio extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ServletTipoServicio</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ServletTipoServicio at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        /*
        Data:1 Obtener todos los tipos servicio
        */
        try {
        ...
        try {
            if(!request.getParameter("btnAgregar").isEmpty()){
                ...
                if(valor.toLowerCase().equals("agregar")){
                    ...
                    if(new ControladorTipoServicio().agregarTipo(ls)){
                    ...
                    if(new ControladorTipoServicio().moficiarTipo(ls)){
                    ...
                    if(new ControladorTipoServicio().eliminarTipo(id)){
